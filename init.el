...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dashboard rainbow-delimiters switch-window rainbow-mode avy smex ido-vertical-mode org-bullets beacon spacemacs-theme which-key use-package cmake-mode)))
(custom-set-faces
